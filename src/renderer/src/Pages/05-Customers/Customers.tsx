...
const Customers = () => {
    ...
    return (
        <div style={{ width: '100%' }}>
            <ToastContainer />
            <Header userName={username} pageName={"Customers"} />
            {
                loadingStatus ? (
                    ...
                    <div className="contentPage">
                        ...
                        <Button label="New Customer" severity="warning" style={{ backgroundColor: "#f6931f" }} onClick={() => { setNewData(true) }} />
                        ...
                        <Sidebar visible={updateData} style={{ width: "80vw" }} position="right" onHide={() => setUpdateData(false)}>
                            ...
                            <CustomerInputsUpdate custId={updateUserId.custId} id={updateUserId.id} closeSidebarUpdate={closeSidebarUpdate} />
